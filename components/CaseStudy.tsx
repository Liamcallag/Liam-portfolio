...
export default function CaseStudy({
  ...
  return (
    <div>
      ...
      {/* ── HEADER ─────────────────────────────────────────────────────────── */}
      <div className="bg-white grid grid-cols-1 md:grid-cols-4 border-b border-[#e5e5e5] min-h-[18vh] md:min-h-[70vh]">
        ...
        <div className="md:col-span-3 md:border-r border-b md:border-b-0 border-[#e5e5e5] p-6 md:p-10 flex flex-col justify-center relative">
          ...
          <h1 className="text-5xl md:text-[10vw] font-bold leading-none text-black tracking-tight">
            {title}
          </h1>
        </div>
